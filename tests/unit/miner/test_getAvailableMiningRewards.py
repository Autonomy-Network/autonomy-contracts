...
def test_getAvailableMiningRewards(asc, mockTarget, ethForCall, requester, executor, referer):
...
def test_getAvailableMiningRewards_requester_executor_referer_same(asc, stakedMin, mockTarget):
