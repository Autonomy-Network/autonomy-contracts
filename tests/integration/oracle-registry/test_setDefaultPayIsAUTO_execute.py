...
def test_newReq_setDefaultPayIsAUTO_executeHashedReq(auto, mockTarget, evmMaths):
    ...
    req = (auto.BOB.address, mockTarget.address, auto.DENICE, callData, msgValue, ethForCall, False, True, False)
    tx = auto.r.newReq(mockTarget, auto.DENICE, callData, ethForCall, False, True, {'from': auto.BOB, 'value': msgValue})
